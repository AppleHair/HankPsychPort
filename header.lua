...
--[[
    ...
    To add to your current working script, use `---@module "header"` into the top of the script, 
    and have this file in the bin/ directory (where the assets or mods folder is found). 
    This will add syntax highlighting, code completion, and much more
...
---@param left string | common_colors Stick to "0xAARRGGBB" or "RRGGBB" format
---@param right? string | common_colors Stick to "0xAARRGGBB" or "RRGGBB" format
...
---@param framerate? number Frames to play per second. Defaults to 24fps
function addAnimationByIndices(tag, name, prefix, indicies, framerate) end
...
---@param indicies string What frames to use, must be seperated by a comma: `"0, 1, 2, 3, 4, 5"`
---@param framerate? number Frames to play per second. Defaults to 24fps
function addAnimationByIndicesLoop(tag, name, prefix, indicies, framerate) end
...
---@alias aligntags "left" | "right" | "center"
...
---@param tag string Text object name
---@param font string Text font file name
function setTextFont(tag, font) end
...
---@param tag string Tween tag name, for `onTweenCompleted` callback
---@param obj string The object to tween
---@param value number The new X value
---@param duration number The time it takes for the Tween to take place. In seconds
---@param ease? ease The tweening method used. Default is `'linear'`
...
---@param tag string Tween tag name, for `onTweenCompleted` callback
---@param camera cameras The camera to tween
...
---@param tag string Tween tag name, for `onTweenCompleted` callback
---@param obj string The object to tween
---@param color string The new Color value
---@param duration number The time it takes for the Tween to take place. In seconds
---@param ease? ease The tweening method used. Default is `'linear'`
...
---@param color string Hexadecimal color in `0xAARRGGBB` or `RRGGBB` format
...
---@deprecated  
---Alias to [FlxAnimationController.addByPrefix](https://api.haxeflixel.com/flixel/animation/FlxAnimationController.html#addByPrefix)\
---*Deprecated: Use `addAnimationByIndices`*
---@param tag string Object to add the animation to
---@param name string Name of the animation
---@param prefix string Animation prefix from the XML
---@param indicies string Whether the animation plays once or loops
---@param framerate number The frames played per second
function luaSpriteAddAnimationByIndices(tag, name, prefix, indicies, framerate) end
...
---@param tag string The tag of the sprite
---@param camera cameras The name of the camera variable in `PlayState`
